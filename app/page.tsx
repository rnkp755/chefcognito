...
import { Camera, ChefHat, Sparkles, MessageCircle, RotateCcw } from "lucide-react"
...
import { DynamicLayoutProvider, useLayout } from "@/components/dynamic-layout-provider"
            ...
            <div className="max-w-4xl mx-auto text-center space-y-8">
              <div className="space-y-4">
                <h2 className="text-4xl font-bold tracking-tight sm:text-6xl">
                  Transform Your Ingredients Into <span className="text-primary">Delicious Recipes</span>
                </h2>
                <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                  Simply snap a photo of your available ingredients and let our AI suggest amazing recipes you can make
                  right now.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
                <Card>
                  ...
                  <CardContent>
                    <CardDescription>
                      Take a picture of your available ingredients and let AI detect what you have.
                    </CardDescription>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <CardDescription>
                      Our AI identifies ingredients, estimates quantities, and considers your preferences.
                    </CardDescription>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <CardDescription>
                      Receive personalized recipe suggestions from basic to advanced cooking levels.
                    </CardDescription>
                  </CardContent>
                </Card>
              </div>
    ...
    <div className="max-w-7xl mx-auto space-y-8">
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground">
          ...
          {layoutState.currentStep === "recipes" && "Explore your personalized recipes and chat with our AI assistant"}
        </p>
      </div>
      ...
      <div
        className={cn(
          ...
          layoutState.focusMode === "upload" && "grid place-items-center",
          layoutState.focusMode === "ingredients" && "grid lg:grid-cols-2 gap-8",
          layoutState.focusMode === "recipes" && "grid xl:grid-cols-3 gap-8",
          layoutState.focusMode === "balanced" && "grid xl:grid-cols-3 gap-8",
        )}
      >
        ...
        {layoutState.showUpload && (
          <div
            className={cn(
              ...
              layoutState.focusMode === "upload" && "w-full max-w-2xl",
              layoutState.focusMode === "ingredients" && "space-y-6",
              layoutState.focusMode === "recipes" && "hidden",
            )}
          >
            <div
              className={cn(
                layoutState.focusMode === "upload" && "scale-100",
                layoutState.focusMode === "ingredients" && "scale-90 opacity-75",
              )}
            >
        ...
        {/* Ingredients Section */}
        {layoutState.showIngredients && detectedIngredients.length > 0 && (
          <div
            className={cn(
              "transition-all duration-500 ease-in-out",
              layoutState.focusMode === "ingredients" && "space-y-6",
          ...
          >
            <IngredientsDisplay ingredients={detectedIngredients} onIngredientsChange={handleIngredientsChange} />
          </div>
        )}
        ...
        {detectedIngredients.length > 0 && (
          <div
            className={cn(
              "transition-all duration-500 ease-in-out",
              layoutState.focusMode === "recipes" && "xl:col-span-2",
            )}
          >
            <RecipeSuggestions ingredients={detectedIngredients} onRecipesGenerated={handleRecipesGenerated} />
          </div>
        )}
        ...
        {!layoutState.isChatMinimized && (
          <div
            className={cn(
              "transition-all duration-500 ease-in-out",
              layoutState.focusMode === "recipes" && "xl:col-span-1",
            )}
          >
            <CollapsibleChat
